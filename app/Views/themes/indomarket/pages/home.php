            ...
            <div class="row mt-4">
                <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                    <div class="single-product">
                        ...
                        <div class="product-content">
                            <h3><a href="product-detail.html">Logitech G703 Lightspeed Kabellos Gaming Mouse</a></h3>
                            <div class="product-price">
                                <span>Rp 1.207.005</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                    <div class="single-product">
                        ...
                        <div class="product-content">
                            <h3><a href="product-detail.html">CORSAIR iCUE 465X RGB Tempered Glass Mid-Tower ATX Smart Case - Black</a></h3>
                            <div class="product-price">
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                    <div class="single-product">
                        ...
                        <div class="product-content">
                            <h3><a href="product-detail.html">ASUS ROG STRIX Z490-A Gaming</a></h3>
                            <div class="product-price">
                                <span>Rp 4.501.045</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                    <div class="single-product">
                        ...
                        <div class="product-content">
                            <h3><a href="product-detail.html">Turtle Beach RECON 150 Wired Gaming Headset</a></h3>
                            <div class="product-price">
